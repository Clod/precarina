...
const textEnglish = r"""
<p>Lipids: Dyslipidemia present in childhood persists into adulthood and is a risk marker for the development of atherosclerosis. In obesity, there is generally an increase in triglyceride levels, low HDL cholesterol, and a slight increase in LDL cholesterol.</p>
<table cellspacing="0" cellpadding="5" style=" font-size: 0.65em; height: 307px; border: 1px solid black; border-collapse: collapse; border: 4px solid black; margin-left: auto; margin-right: auto;">
<tbody>
<tr style="height: 57px; ">
<td style="border: 1px solid black; height: 57px; width: 160px;"></td>
<td style="border: 1px solid black; height: 57px; width: 92.4453px; text-align: center;">
ACCEPTABLE
</td>
<td style="border: 1px solid black; height: 57px; width: 76.7891px; text-align: center;">
